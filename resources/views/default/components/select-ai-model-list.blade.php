        ...
        <x-slot:head-content>
            <div class="flex flex-wrap justify-between gap-y-3 sm:grow sm:flex-nowrap">
                ...
                <div class="lg:ms-auto">
                    <form action="#">
                        <x-forms.input
                            class="sm:min-w-64 max-h-9 rounded-full bg-clay ps-8"
                            type="search"
                            placeholder="{{ __('Search model') }}"
                            @input="searchString = $event.target.value"
                        >
                            <x-slot:icon>
                                <x-tabler-search class="size-4 absolute start-3 top-1/2 -translate-y-1/2" />
                            </x-slot:icon>
                        </x-forms.input>
                    </form>
                </div>
                                ...
                                >
                                    <div class="w-full">
                                        <div class="mb-6 flex justify-between gap-1.5">
                                            <figure class="size-10 inline-grid shrink-0 place-content-center rounded-full bg-heading-foreground/5">
